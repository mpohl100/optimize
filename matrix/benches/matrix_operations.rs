...
fn benchmark_matrix_creation(c: &mut Criterion) {
    ...
    for size in [10, 50, 100, 200, 500].iter() {
        group.bench_with_input(
            BenchmarkId::new("WrappedMatrix", size),
            size,
            |b, &size| {
                b.iter(|| {
...
fn benchmark_matrix_access(c: &mut Criterion) {
    ...
    for size in [50, 100, 200].iter() {
        ...
        group.bench_with_input(
            BenchmarkId::new("get_unchecked", size),
            size,
            |b, &size| {
                b.iter(|| {
                    for i in 0..size {
        ...
        group.bench_with_input(
            BenchmarkId::new("set_mut_unchecked", size),
            size,
            |b, &size| {
                b.iter(|| {
                    for i in 0..size {
...
fn benchmark_sum_matrix_operations(c: &mut Criterion) {
    ...
    for size in [50, 100, 200].iter() {
        ...
        group.bench_with_input(
            BenchmarkId::new("get_row_sum", size),
            size,
            |b, &size| {
                b.iter(|| {
                    for i in 0..size {
        ...
        group.bench_with_input(
            BenchmarkId::new("get_ratio", size),
            size,
            |b, &size| {
                b.iter(|| {
                    for i in 0..size {
